            ...
            <div className='row'>
                <div className='col-md-3'>
                    <div className='card p-3 m-2 shadow bg-success text-white'>
                        <p className='h3'>total : {user.length}</p>
                    </div>
                </div>
                <div className='col-md-3'>
                    <div className='card p-3 m-2 shadow bg-warning text-white'>
                        <p className='h3'>Female : {user.filter((d)=>{return d.gender==="female"}).length}</p>
                    </div>
                </div>
                <div className='col-md-3'>
                    <div className='card p-3 m-2 shadow bg-info text-white'>
                        <p className='h3'>Male : {user.filter((d)=>{return d.gender==="male"}).length}</p>
                    </div>
                </div>
                <div className='col-md-3'>
                    <div className='card p-3 m-2 shadow bg-danger text-white'>
                        <p className='h3'>total : 5400</p>
                    </div>
                </div>
            </div>
         <div className='row'>
